...
def _sidebar_state(request):
    ...
    route_groups = [
        ...
        ({"staff.list_staff", "staff.dashboard", "staff.create_staff", "staff.edit_staff", "staff.delete_staff"}, "admin.staff", "Staff"),
        ...
        ({"admin.pending_approvals", "admin.pending_guides", "admin.all_guides", "admin.review_guide", "admin.approve_guide", "admin.reject_guide"}, "admin.approvals", "Approvals"),
